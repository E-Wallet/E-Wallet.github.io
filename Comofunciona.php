...
<html lang="pt-br">
    <head>
        ...
        <title>E-Wallet - Como Funciona</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9" id="destaques">
                        <h1 id="destaques_tit"><font face="Eras ITC">Como funciona o gerenciamento?</font></h1>
                        <br>
                        <div class="texto">
                            <h3 class="titulos">1 - Login</h3>
                            <p>Faça login no sistema (se já estiver cadastrado) ou cadastre-se;</p>
                            <h3 class="titulos">2 - Buscar Produto</h3>
                            <p>Busque um produto ou um serviço em nossa barra de pesquisa, 
                                 ou escolha um de sua preferencia em nossa tela de destaques</p>
                             <h3 class="titulos">3 - Análise</h3>
                             <p>Analíse o produto faça o cálculo de viabilidade</p>
                             <h3 class="titulos">4 - Cálculo e Gerenciamento</h3>
                             <p>Se estiver satisfeito com o resultado do cálculo e descidir obter o produto
                                 adicione-o ao seu gerenciamento, para poder acompanhar e gerenciar o pagamanto.</p>
