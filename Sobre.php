            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9" id="destaques">
                        <h1 id="destaques_tit"><font face="Eras ITC">Sobre</font></h1>
                        <br>
                        <p>Sistema pensado e desenvolvido por Eduardo Rodrigues Ribeiro, Felipe Mudryk Pereira,
                            Samuel José Costa e Gabriel Alpendre, como requisito avaliativo do segundo bimestre para a máteria de PI - 5.</p>
                    </div>
                </div>
            </div>
        </main>
