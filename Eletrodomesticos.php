...
<html lang="pt-br">
    <head>
        ...
        <title>E-Wallet - Elétrodomesticos</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9" id="destaques">
                        <h1 id="destaques_tit"><font face="Eras ITC">Automóveis</font></h1>
                        <br>
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card" style="width: 16rem;">
                                    <img class="card-img-top" src="Imagens/vitrine.PNG" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Elétrodomestico 1</h5>
                            ...
                            <div class="col-sm-4">
                                <div class="card" style="width: 16rem;">
                                    <img class="card-img-top" src="Imagens/vitrine.PNG" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Elétrodomestico 2</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <a href="#" class="btn btn-primary">Ver Produto</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card" style="width: 16rem;">
                                    <img class="card-img-top" src="Imagens/vitrine.PNG" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Elétrodomestico 3</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <a href="#" class="btn btn-primary">Ver Produto</a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card" style="width: 16rem;">
                                    <img class="card-img-top" src="Imagens/vitrine.PNG" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Elétrodomestico 4</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <a href="#" class="btn btn-primary">Ver Produto</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card" style="width: 16rem;">
                                    <img class="card-img-top" src="Imagens/vitrine.PNG" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Elétrodomestico 5</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <a href="#" class="btn btn-primary">Ver Produto</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="card" style="width: 16rem;">
                                    <img class="card-img-top" src="Imagens/vitrine.PNG" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">Elétrodomestico 6</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        <a href="#" class="btn btn-primary">Ver Produto</a>
                                    </div>
                                </div>
